...
clear
toilet -t --metal "Спиздили"
toilet -t --metal "отделZ"
toilet -t --metal " HagridRX"

if [[ $mhddos_mode == "new" ]]; then
    typing_on_screen 'Спиздил HagridRX...' && sleep 1
else
    typing_on_screen 'Спиздил...' ; sleep 0.5
...
if [[ $mhddos_mode == "new" ]]; then
    ...
    while true; do
    cd ~/multidd/
    git clone https://github.com/artemkoval1994/mhddos_proxy.git
